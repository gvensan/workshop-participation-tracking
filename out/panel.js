...
exports.WorkshopPanel = void 0;
const vscode = require("vscode");
const webhookReporter_1 = require("./webhookReporter");
class WorkshopPanel {
    constructor(context, store, sections, onDispose) {
        this.progressChangedEmitter = new vscode.EventEmitter();
        this.onProgressChanged = this.progressChangedEmitter.event;
        this.store = store;
        this.sections = sections;
        this.reporter = new webhookReporter_1.WebhookReporter();
        this.onDispose = onDispose;
        this.panel = vscode.window.createWebviewPanel("workshopTracker", "Workshop Tracker", vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    render() {
        ...
        const sectionsJson = JSON.stringify(this.sections.map(s => ({
            ...s,
...
exports.WorkshopPanel = WorkshopPanel;
